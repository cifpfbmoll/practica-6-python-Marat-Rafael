"""
Desarrolla un programa junto con tu compañero, 
apoyándote en la “metodología pair programming” que tenga las siguientes características:
Piensa en un problema que requiera para su resolución el uso de sentencias repetitivas.
Dicho problema devuélvelo con bucles for y while. 
...
una solución es más eficiente? 
Investiga para comprobarlo.
"""